				...
				<ul class="sidebar-links" id="simple-bar">
					...
					<li class="sidebar-list">
						...
						<ul class="sidebar-submenu" style="display: {{ request()->route()->getPrefix() == '/dashboard' ? 'block;' : 'none;' }}">
							<li><a class="lan-4 {{ Route::currentRouteName()=='index' ? 'active' : '' }}" href="{{route('dashboard')}}">{{ trans('lang.Default') }}</a></li>
					...
					<li class="sidebar-list">
						...
						<ul class="sidebar-submenu" >
							<li class=" customizer-color"><a href="{{route('dashboard')}}">Boxed</a></li>
							<li class=" customizer-color"><a href="{{route('dashboard')}}">RTL</a></li>
							<li class=" customizer-color dark"><a href="{{route('dashboard')}}">Dark Layout</a></li>
							<li class=" customizer-color"><a href="{{route('dashboard')}}">Hide Nav Scroll</a></li>
							<li class=" customizer-color"><a href="{{route('dashboard')}}">Footer Light</a></li>
							<li class=" customizer-color"><a href="{{route('dashboard')}}">Footer Dark</a></li>
							<li class=" customizer-color"><a href="{{route('dashboard')}}">Footer Fixed</a></li>
						</ul>
					</li>
					<li class="sidebar-main-title">
						<div>
