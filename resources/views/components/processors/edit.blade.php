<div class="modal fade" id="edit-processor" tabindex="-1" role="dialog" aria-labelledby="edit-processor" aria-hidden="true">
                ...
                <div class="mt-3">
                    ...
                    <div class="w-100">
                        <input id="name" type="text" class="form-control"
                               name="name" x-model="processor.name"/>
                    </div>
                </div>
                <div class="mt-3">
                    ...
                    <div class="w-100">
                        <input id="host" type="text" class="form-control"
                               name="host" x-model="processor.host"/>
                    </div>
                </div>
                <div class="mt-3">
                    ...
                    <div class="w-100">
                        <input id="port" type="text" class="form-control"
                               name="port" x-model="processor.port"/>
                    </div>
                </div>
                <div class="mt-3">
                    ...
                    <div class="w-100">
                        <input id="comp1" type="text" class="form-control"
                               name="comp1" x-model="processor.comp1"/>
                    </div>
                </div>
                <div class="mt-3">
                    ...
                    <div class="w-100">
                        <input id="comp2" type="text" class="form-control"
                               name="comp2" x-model="processor.comp2"/>
                    </div>
                </div>
                <div class="mt-3">
                    ...
                    <div class="w-100">
                        <input id="zpk" type="text" class="form-control"
                               name="zpk" x-model="processor.zpk"/>
                    </div>
                </div>
