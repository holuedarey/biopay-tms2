(function ($) {
  ...
  if ($("#pageWrapper").hasClass("compact-wrapper")) {
    ...
    jQuery(".sidebar-title").click(function () {
      ...
      if (jQuery(this).next().is(":hidden") == true) {
        jQuery(this).addClass("sb-active");
        jQuery(this)
          .find("div")
          .replaceWith(
    ...
    const horizontalMenu = () => {
      ...
      if (contentwidth <= 992 && !smallSize) {
        ...
        jQuery(".submenu-title").click(function () {
          jQuery(".submenu-title").removeClass("sb-active");
          jQuery(".submenu-title")
            .find("div")
            .replaceWith(
              '<div class="according-menu"><i class="fa fa-angle-right"></i></div>'
        ...
        jQuery(".sidebar-title").click(function () {
          jQuery(".sidebar-title").removeClass("sb-active");
          jQuery(".sidebar-title")
            .find("div")
            .replaceWith(
              '<div class="according-menu"><i class="fa fa-angle-right"></i></div>'
    ...
    jQuery(".sidebar-title").click(function () {
      jQuery(".sidebar-title").removeClass("sb-active");
      $(".bg-overlay1").removeClass("sb-active");
      ...
      if (jQuery(this).next().is(":hidden") == true) {
        jQuery(this).addClass("sb-active");
        jQuery(this).next().slideDown("normal");
        $(".bg-overlay1").addClass("sb-active");
  ...
  $(window).on("overlay", function () {
    ...
    if ($(window).width() <= 991 && !$isHidden && $bgOverlay.length === 0) {
      $('<div class="bg-overlay sb-active"></div>').appendTo($("body"));
    }
  ...
  // page active
  if ($("#pageWrapper").hasClass("compact-wrapper")) {
    $(".sidebar-wrapper nav").find("a").removeClass("sb-active");
    $(".sidebar-wrapper nav").find("li").removeClass("sb-active");

    let current = window.location.pathname;

    $(".sidebar-wrapper nav ul li a").filter(function () {
      let link = $(this).attr("href");
      let slashCount = (link.match(/\//g) || []).length;

      if (link?.includes(current)) {
        $(this).parents().children("a").addClass("sb-active");
  ...
  $(".left-header .link-section > div").on("click", function (e) {
    if ($(window).width() <= 1199) {
      $(".left-header .link-section > div").removeClass("sb-active");
  ...
  if (
    ...
    let simpleBarTop = $('.simplebar-wrapper .simplebar-content-wrapper a.sb-active').offset()?.top;
    if (simpleBarTop) {
      $('.simplebar-wrapper .simplebar-content-wrapper').animate({
        scrollTop: simpleBarTop - 400
      }, 1000);
    }
  }
})(jQuery);
